...
/**
 * Created by Luc1412 on 03.12.2017 at 19:17
 */
public class Song {
	...
	Song(float speed, HashMap<Integer, Layer> layerHashMap, short songHeight, final short length, String title, String author, String description, File path, CustomInstrument[] customInstrument) {
		this.speed = speed;
		delay = 20 / speed;
